import { Card, Typography, Space, Tag, Alert, Spin, Empty, Collapse, Badge } from 'antd'
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <Card>
        <Space>
          ...
          <Title level={4} style={{ margin: 0 }}>School Announcements</Title>
      ...
      {pinned.map((a) => (
        <Card
          ...
          extra={<Tag color="orange">📌 Pinned</Tag>}
      ...
      {announcements.length === 0 && (
        <Card><Empty description="No announcements at this time." imageStyle={{ height: 60 }} /></Card>
      )}
    </div>
  )
}
